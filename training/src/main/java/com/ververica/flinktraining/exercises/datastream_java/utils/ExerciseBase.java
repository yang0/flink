...
public class ExerciseBase {
	...
	public final static String pathToRideData = "e:/dev_software/flink/training_data/nycTaxiRides.gz";
	public final static String pathToFareData = "e:/dev_software/flink/training_data/nycTaxiFares.gz";
